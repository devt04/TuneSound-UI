...
import style from "./hiphopRapList.module.css";
...
export default function RapListPage () {
     ...
     return (
          <>
               ...
               <div className={clsx(style.rapListPage)}>
                    <div className={clsx(style.titlePage)}>
                         <h4>Bài hát thuộc thể loại : HipHop & Rap</h4>
                         <div className={clsx(style.lineBtTitle)}></div>
                    </div>

                    <div className={clsx(style.listSoundRap)}>
