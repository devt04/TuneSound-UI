...
import style from "./remixList.module.css";
...
export default function RemixListPage () {
     ...
     return (
          <>
               ...
               <div className={clsx(style.remixListPage)}>
                    <div className={clsx(style.titlePage)}>
                         <h4>Bài hát thuộc thể loại : Remix</h4>
                         <div className={clsx(style.lineBtTitle)}></div>
                    </div>

                    <div className={clsx(style.listSoundRemix)}>
                         {dataSongsServer.map((data, index) => {
                              if(data.category_sound === "Remix") {
                                   return (
                                        <div key={index} className={clsx(style.itemSoundRemix)}>
