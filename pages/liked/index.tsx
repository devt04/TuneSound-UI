...
export default function RapListPage () {
     ...
     return (
          <>
               ...
               <div className={clsx(style.likedListPage)}>
                    <div className={clsx(style.titlePage)}>
                         <h4>Danh sách bài hát yêu thích</h4>
                         <div className={clsx(style.lineBtTitle)}></div>
                    </div>

                    <div className={clsx(style.listSoundLiked)}>
                         {dataSongsServer.map((data, index) => {
                              if(data.liked === true) {
                                   return (
                                        <div key={index} className={clsx(style.itemSoundLiked)}>
